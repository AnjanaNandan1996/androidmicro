...
public class serviceprovider extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.serviceprovider, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.i1) {
            Intent in=new Intent(serviceprovider.this,signinactvity.class);
            startActivity(in);
            // Handle the camera action
        } else if (id == R.id.i2) {
            Intent in=new Intent(serviceprovider.this,Singup.class);
            startActivity(in);
