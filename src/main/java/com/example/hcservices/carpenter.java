...
public class carpenter extends AppCompatActivity {
    ...
    ArrayList<String> catag = new ArrayList<String>();
    String ar[];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent in = getIntent();
        final String cate = in.getStringExtra("catag");
      ...
      /*  while(c.moveToNext())
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,catag);
        l3.setAdapter(arrayAdapter);
